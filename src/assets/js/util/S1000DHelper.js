...
function resolve_infoEntityIdent(infoEntityIdent, prefix = "", format = ""){
  ...
  let infoEntityRefIdent; infoEntityRefIdent = (infoEntityRefIdent = infoEntityIdent.find(v => v['at_infoEntityRefIdent'])) ? infoEntityRefIdent['at_infoEntityRefIdent'] : '';
